...
#define BASERESISTANCE 100 //kohm
#define MAXVOLT 3.3
#define LENGTH 2000
/* USER CODE END PM */
...
/* USER CODE BEGIN PV */
uint16_t adcValue[LENGTH];
int nOfConversions = 0;
...
int main(void)
{
  ...
  HAL_ADC_Start_DMA(&hadc1, (uint32_t*)adcValue, adcValue/adcValue[0]);
  /* USER CODE END 2 */
...
static void MX_ADC1_Init(void)
{
  ...
  */
  ...
  hadc1.Init.NbrOfConversion = LENGTH;
